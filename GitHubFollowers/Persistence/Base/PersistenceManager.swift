...
struct PersistenceManager {
    ...
    func update(with favorite: Follower, actionType: PersistenceActionType, completed: @escaping (GFPersistenceError?) -> ()) {
    ...
    func retrieveFavorites(completed: @escaping (Result<[Follower], GFPersistenceError>) -> ()) {
    ...
    func save(favorites: [Follower]) -> GFPersistenceError? {
        do {
